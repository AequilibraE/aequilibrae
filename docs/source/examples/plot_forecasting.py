...
# We could setup a generalized cost function to assign this mode, for example
# assigclass.set_cost_function(fixed_cost_field='distance', fixed_cost_parameter=0.1, time_cost_parameter=1.2)
