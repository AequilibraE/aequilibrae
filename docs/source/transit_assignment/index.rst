...
In the following sections, we'll present the ``TransitGraph``, the graph structure used for a transit
network, and the hyperpath routing for transit assignment.
