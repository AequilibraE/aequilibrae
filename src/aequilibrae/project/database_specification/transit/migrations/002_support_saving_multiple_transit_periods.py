...
def migrate(
    *,
    ...
    if project_conn is None:
        raise RuntimeError("Transit migration 002 requires a project_conn connection")
    if transit_conn is None:
        raise RuntimeError("Transit migration 002 requires a transit_conn connection")
