...
template <class Derived> class PriorityQueueBase {
public:
  ...
  [[nodiscard]] double peek() const noexcept { return derived().peek_impl(); }
  ...
  effective_state(std::size_t element_idx) const noexcept {
