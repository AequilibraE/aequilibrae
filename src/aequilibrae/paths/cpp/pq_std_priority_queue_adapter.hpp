...
namespace aequilibrae::paths::cpp
{
    ...
    class StdPriorityQueueAdapter final : public PriorityQueueBase<StdPriorityQueueAdapter>
    {
    public:
    ...
    private:
        ...
        [[nodiscard]] double peek_impl() noexcept
        {
        ...
        [[nodiscard]] ElementState effective_state_impl(std::size_t element_idx) const noexcept
        {
            return states_[element_idx];
        }

        [[nodiscard]] double element_key_impl(std::size_t element_idx) const noexcept
        {
