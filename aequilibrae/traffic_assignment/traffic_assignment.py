...
from aequilibrae.traffic_assignment.traffic_class import TrafficClass, TransportClassBase
from aequilibrae.traffic_assignment.vdf import VDF, all_vdf_functions
...
class TrafficAssignment(AssignmentBase):
    ...
    .. code-block:: python
        ...
        >>> from aequilibrae.traffic_assignment import TrafficAssignment, TrafficClass
