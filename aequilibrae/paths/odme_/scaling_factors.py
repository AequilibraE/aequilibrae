...
class ScalingFactors(object):
    ...
    def __init__(self, odme: 'ODME', algorithm: str) -> None:
        ...
        # Partition count volumes per class for ease of use
    ...
    def __get_step_sizes_spiess(self, gradients: list[np.ndarray]) -> list[float]:
        ...
        # (see technical documentation) - however this likely doesn't give rise to
        # any significant speed increase.
    ...
    def __reg_spiess(self) -> list[np.ndarray]:
        ...
        NOTE - multi-class ODME is NOT yet supported for this algorithm,
        the technical documentation has not been updated to check for certain
        how this should be implemented for such cases.
        """
        # Derivative matrices for spiess algorithm:
