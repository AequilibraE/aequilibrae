...
def main():
    ...
    with warnings.catch_warnings():
        ...
        for project_name in args["projects"]:
            no_sl = final.loc[(final["Project"] == project_name) & (final["Select_Link"] == False)]["Minimum_Runtime"].values[0]
            sl = final.loc[(final["Project"] == project_name) & (final["Select_Link"] == True)]["Minimum_Runtime"].values[0]
