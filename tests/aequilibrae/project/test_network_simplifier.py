...
def project_with_graph(nauru_example):
    ...
    yield nauru_example, graph


def test_simplify(project_with_graph):
    project, graph = project_with_graph
    net = NetworkSimplifier(project.network, project.scenario.db_connection)
